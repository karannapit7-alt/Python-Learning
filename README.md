...
2. *List and Tuple*: Practice files for list methods and tuple manipulation.
3. *String and conditional*: Contains programs for strings and decision-making (if-elif-else).
